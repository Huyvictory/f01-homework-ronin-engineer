...
public class Assignment_4 {
    ...
    private static void Bai3() {
        ...
        int n = Assignment_3.InputValidIntegerNumber(scanner3, "n");
    ...
    private static void Bai7() {
        ...
        int n = Assignment_3.InputValidIntegerNumber(scanner7, "n");
    ...
    private static void Bai8() {
        ...
        int n = Assignment_3.InputValidIntegerNumber(scanner8, "n");
    ...
    private static void Bai9() {
        double piNumber = 0.0;
        int i = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "i");
