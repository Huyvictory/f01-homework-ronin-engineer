...
public class Assignment_6 {
    ...
    private static void Bai4() {
        ...
        int n = Assignment_3.InputValidIntegerNumber(scanner4, " n: ");

        int arrayNumbers[] = new int[n];
        for (int i = 0; i < n; i++) {

            arrayNumbers[i] = Assignment_3.InputValidIntegerNumber(scanner4, "Enter valid integer number " + (i + 1) + ": ");
        }

        int k = Assignment_3.InputValidIntegerNumber(scanner4, "Enter valid integer number k: ");
    ...
    private static void Bai5() {
        ...
        int n = Assignment_3.InputValidIntegerNumber(scanner5, " n: ");

        int[] customerNotes = new int[n];

        for (int i = 0; i < n; i++) {
            customerNotes[i] = Assignment_3.InputValidIntegerNumber(scanner5, "Enter note of customer " + (i + 1) + ": ");
        }
    ...
    private static void Bai6() {
        ...
        int a = Assignment_3.InputValidIntegerNumber(scanner6, "amount of height that snail can climb per day");

        // Input amount of height that snail drops per day after a sleep night
        int b = Assignment_3.InputValidIntegerNumber(scanner6, "amount of height that snail drops per day after a sleep night");

        // Input height of the pole that snail has to climb
        int v = Assignment_3.InputValidIntegerNumber(scanner6, "height of the pole");
    ...
    private static void Bai7() {
        ...
        int redShoe = Assignment_3.InputValidIntegerNumber(scanner7, "red shoe");

        // Input numbers of blue shoe
        int blueShoe = Assignment_3.InputValidIntegerNumber(scanner7, "blue shoe");
