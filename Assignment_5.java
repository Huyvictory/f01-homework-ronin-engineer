...
public class Assignment_5 {
    ...
    private static int Bai2() {
        ...
        int n = Assignment_3.InputValidIntegerNumber(scanner, "n");
    ...
    private static void Bai7() {
        ...
        // Get number of tests
        int numberOfTests = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "number of tests");
        ...
        for (int i = 1; i <= numberOfTests; i++) {
            ...
            int a = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "a");
            int b = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "b");
    ...
    private static void Bai8() {
        ...
        for (int i = 1; i <= numberOfTests; i++) {
            System.out.println();
            System.out.printf("Test case %d\n", i);
            int n = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "size of the array for test case " + i);
            int[] arrayNumbers = new int[n];

            for (int j = 0; j < n; j++) {
                arrayNumbers[j] = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "array number " + (j + 1));
            }
    ...
    private static void Bai9() {
        ...
        for (int i = 1; i <= numberOfTests; i++) {
            System.out.println();
            System.out.printf("Test case %d\n", i);
            int n = Assignment_3.InputValidIntegerNumber(new Scanner(System.in), "integer n");
            testCases.add(n);
        }
